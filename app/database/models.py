from sqlalchemy import Column, Integer, String, Boolean, DateTime, ForeignKey, Index, update
...
class Session(Base):
    ...
    AgreementPart1Version = Column(Unicode(64), nullable=False)
    HasAgreedToPart2 = Column(Boolean(1), default=False, nullable=False)
    AgreementPart2Version = Column(Unicode(64), nullable=False)
